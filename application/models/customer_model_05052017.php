...
class Customer_model extends Super_Model
{
	...
	function getCustomerAccountLog($customer='',$type='',$in_type='',$in_status='',$date=''){
	...
	function getCustomerinfo($cus_id)
	{
			...
			LEFT JOIN a_customer_account_partner ON a_customer_account_partner.customer='".intval($cus_id)."' AND a_customer_account_partner.partner='".$current_partner."' AND a_customer_account_partner.partner_branch = '".$current_partner_branch."'
	...
	function customermobileinfo($mobile)
	{
		...
		$current_partner=$this->session->userdata['partner'];
		$current_partner_branch=$this->session->userdata['partner_branch'];
		$query=$this->db->query("SELECT b.firstname,b.lastname,b.sex,c.email,a.number as mobile,a.customer as id,d.street_line_1,d.street_line_2,d.floor,d.calling_bell,d.zip,p.name as partner_name,pb.name as partner_branch_name,b.autofil_invoice
		FROM a_phone a 
	...
	function customerAccountinfo($id)
	{
		...
		$query=$this->db->query("SELECT b.id,b.firstname,b.lastname,b.sex,c.email,a.number as mobile,d.street_line_1,d.street_line_2,d.floor,d.calling_bell,d.zip,p.name as partner_name,pb.name as partner_branch_name,a_company_customer.type,a_company_customer.company,a_company.name as companyname
