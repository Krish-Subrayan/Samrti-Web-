...
class REST_Controller extends MY_Controller {
	...
	private function _check_login($username = '', $password = NULL)
	{
		...
		//$valid_logins = & $this->config->item('rest_valid_logins');   // authentication using  username and pwd
		
		/*Authentication using username & pwd from database */
		$this->load->model('employee_model');
		$valid_logins = $this->employee_model->getValidLogins($username,$password);
