...
define('FILES_TASKS_FOLDER', FCPATH.'files/tasks/');
...
define('FILES_IMAGE_FOLDER', FCPATH.'images/');
define('PRINT_FILES_FOLDER', 'application/third_party/WebClientPrint/files/');
define('EMPLOYEE_IMAGE_FOLDER', "https://".$_SERVER['SERVER_NAME']."/images/employees/");
//define('PATHS_PRINT_IMAGES', FCPATH.'images/print/'); 
define('PATHS_PRINT_IMAGES', FCPATH."application/third_party/WebClientPrint/images/");
define('PATH_IMAGE_FOLDER', "http://".$_SERVER['SERVER_NAME']."/images/" );
