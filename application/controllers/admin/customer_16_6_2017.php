				...
				if(count($companyinfo) > 0)//1
					{
						...
						foreach($companyinfo as $companyitems)
						{
							...
							$heatinfo='';
								...
								$heatinfo.='<select onchange="setCompany(this.value);" style="height:39px !important;" name="company" id="company" class="form-control"><option value="">-- Select Company --</option>';
