...
class Project extends MY_Controller
{
    ...
    function __detailsView()
    {
        ...
        /** PERMISSIONS CHECK - PROJECT -------------------------
          ...
          * -----------------------------------------------------*/
        if ($this->data['project_permissions']['view_item_my_project_details'] != 1) {
    ...
    function __editProject()
    {
        ...
        /** PERMISSIONS CHECK - PROJECT -------------------------
          * do this check after __commonAll_ProjectBasics()
          * -----------------------------------------------------*/
        if ($this->data['project_permissions']['edit_item_my_project_details'] != 1) {
            redirect('/admin/error/permission-denied');
        }
    ...
    function __eventsTracker($type = '', $events_data = array())
    {
        ...
        if ($type == 'edit-project') {
            ...
            $events['project_events_link'] = 'project_'.$this->project_id;
