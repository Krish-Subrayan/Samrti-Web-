...
class Tickets extends MY_Controller
{
    ...
    function __addTicket()
    {
        ...
        redirect('/admin/tickets/list/open');
    ...
    function __emailer($email = '', $vars = array())
    {
        ...
        if ($email == 'mailqueue_new_ticket_assigned_team') {
            ...
            profiling(__function__, __line__, "sending ticket email- team:".json_encode($vars), 'ajax');
            
            //do not email me if I am assigning this ticket to myself
