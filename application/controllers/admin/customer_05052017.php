	...
	//echo '<pre>';print_r();exit;
		...
		if(intval($subscription) > 0)
		{
			...
			$this->data['lists']['subscription']=' <input onclick="checkAbonnement();" type="radio"  value="Ja"   class="form-control" checked name="subscribe"  > Ja&nbsp;&nbsp;
			  ...
			  {
				$this->data['lists']['subscription1']=' <input  onclick="checkfaktura();" type="radio"  value="Ja" class="form-control" checked  name="subscribe1" > Ja&nbsp;&nbsp;<input type="radio"  value="Nei"  onclick="checkfaktura();" class="form-control" name="subscribe1" >Nei';
			  }
				...
				if($subscribe == 'Ja')
				{
					if($subscribe1 == 'Ja')
					{
						if($subscribe2 == 'Ja')
						{
							...
							$this->payments_model->addCustomerPayment($paymentarray);
							$this->payments_model->updateCustomerBalance($cus_id,$faktura_value,'pending');
							$this->customer_model->addAutofilInvoice($cus_id,$faktura_value);
