		...
		$this->data['debug'][] = $this->customer_model->debug_data;
            ...
            //set invoice name
             if (!empty($this->data['blocks']['account'])) {
				...
				$str .='<tr>
						<td style="text-align: left;width:30%; padding: 5px 0 5px; font-family: \'arial\', monospace; font-size: 14px; vertical-align: top;">'.$this->data['blocks']['account'][$i]['rdatewy'].'</td>
						<td style="text-align: left; padding: 5px 0 0;width:15%; font-family: \'arial\', monospace; font-size: 14px; font-weight:normal;vertical-align: top; ">'.$this->data['blocks']['account'][$i]['rtime'].'</td>
						<td style="text-align: left; padding: 5px 0 0;width:25%; font-family: \'arial\', monospace; font-size: 14px; font-weight:normal;vertical-align: top; ">'. sprintf('%08d', $orderid).'</td>
						<td style="text-align: center; padding: 5px 0 0;width:5%; font-family: \'arial\', monospace; font-size: 14px; font-weight:normal;vertical-align: top;vertical-align: top; ">'.strtoupper($in_type).'</td>
						<td colspan="2" style="text-align: right; padding: 5px 0 0; font-family: \'arial\', monospace; font-size: 14px; font-weight:normal;vertical-align: top;">kr '.formatcurrency($this->data['blocks']['account'][$i]['amount']).'</td>
					  </tr>';
						if($in_type != 'kk')
						{  
							$total +=	$this->data['blocks']['account'][$i]['amount']; 
