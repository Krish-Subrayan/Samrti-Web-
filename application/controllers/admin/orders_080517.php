...
class Orders extends MY_Controller
{
	...
	function __updateUtleveringDate(){
     ...
     function __getOrders(){
		...
		$currentyearorders1=$this->orders_model->getCustomerOrderhistory($customer_id,'utlevering','',$currentyear);
		
		$currentyear=2;//current year
		$currentyearorders2=$this->orders_model->getCustomerOrderhistory($customer_id,'utlevering','',$currentyear);
		
		$currentyear=3;//Previous year
		$currentyearorders3=$this->orders_model->getCustomerOrderhistory($customer_id,'utlevering','',$currentyear);
