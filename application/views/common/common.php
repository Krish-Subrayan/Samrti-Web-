...
$conf = (isset($conf))? $conf : array();$data['successmsg'] =$this->session->flashdata('notice-success');$data['errormsg'] = $this->session->flashdata('notice-error');
...
$this->tbs->MergeField('version', $data['version']);$this->tbs->MergeField('successmsg', $data['successmsg']);$this->tbs->MergeField('errormsg', $data['errormsg']);
